...
/*
 * This endpoint is designed to send an email notification for an order cancel success
 *
 * The tests are divided into two main categories:
 * - Method-specific test cases for the POST request.
 */
public class PostNotifyServiceNotificationOrderCancelSuccessTest extends BaseComponentTest
{
	private final String url = "/api/v1/notifyservice/notification/order_cancel_success";
	/*
	#####################################
