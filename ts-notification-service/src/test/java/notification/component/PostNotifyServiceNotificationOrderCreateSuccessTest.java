...
/*
 * This endpoint is designed to send an email notification for an order create success
 *
 * The tests are divided into two main categories:
 * - Method-specific test cases for the POST request.
 */
public class PostNotifyServiceNotificationOrderCreateSuccessTest extends BaseComponentTest
{
	private final String url = "/api/v1/notifyservice/notification/order_create_success";
	/*
	#####################################
