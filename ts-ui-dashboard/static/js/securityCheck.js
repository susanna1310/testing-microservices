            ...
            if (result["status"] == true) {
                ...
                for (var i = 0, l = obj.length; i < l; i++) {
                    $("#security_config_list_table").find("tbody").append(
                        ...
                        "<td ><input class='list_security_config_id_value form-control' value='" + obj[i]["value"] +
                        "'></td>" +
                        "<td ><input class='list_security_config_id_description form-control' value='" +
                        obj[i]["description"] + "'></td>" +
                        "<td>" + "<button class='security_config_update_btn btn btn-primary'>Update</button>" +
                        "<button class='security_config_delete btn btn-primary noshow_component'>Delete</button>" +
                        "</td>" +
                        "</tr>"
                    );
                }
