        ...
        $.ajax({
            ...
            success: function (obj) {
                ...
                $("#office_list_table").find("tbody").append(
                    ...
                    "</td>" +
                    "<td>" +
                    "<button id='create_office_button' onclick='createOffice()' class='btn btn-primary'>Add</button>" +
                    "</td>" +
                    "</tr>"
                );
...
{
    // alert($(".add_office_name").val() + $(".add_office_address").val() + $(".add_office_work_time").val() +
    // $(".add_office_window_num").val());

    if ($(".add_office_name").val() && $(".add_office_address").val() && $(".add_office_work_time").val() &&
        $(".add_office_window_num").val())
    {
        var data = new Object();
        data.province = $('#office_province').find("option:selected").text();
