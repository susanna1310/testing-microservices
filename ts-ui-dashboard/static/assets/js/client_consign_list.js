                ...
                success: function (result) {
                    if (result.status == 1) {
                        ...
                        for (var i = 0; i < size; i++) {
                            ...
                            //  that.myConsigns[i].handleDate =
                            // that.convertNumberToDateTimeString(that.myConsigns[i].handleDate);
                            that.myConsigns[i].targetDate =
                                that.convertNumberToDateTimeString(that.myConsigns[i].targetDate);
                        }
                    } else {
                        alert("no consign!")
                    }
