...
priceModule.controller("priceCtrl", function ($scope, $http, loadDataService, $window) {
    ...
    $scope.updatePrice = function (price) {
        ...
        $('#update-price-table').modal({
            relatedTarget: this,
            onConfirm: function (options) {
                if (parseFloat($('#update-price-basic-price-rate').val()) &&
                    parseFloat($('#update-price-first-class-price-rate').val()))
                {
                    var data = new Object();
                    data.id = price.id;
    ...
    $scope.addPrice = function () {
        ...
        $('#add-price-table').modal({
            relatedTarget: this,
            onConfirm: function (options) {
                if (parseFloat($('#add-price-basic-price-rate').val()) &&
                    parseFloat($('#add-price-first-class-price-rate').val()))
                {
                    var data = new Object();
