...
trainModule.controller("trainCtrl", function ($scope, $http, loadDataService, $window) {
    ...
    $scope.updateTrain = function (train) {
        ...
        $('#update-train-table').modal({
            relatedTarget: this,
            onConfirm: function (options) {
                if (parseInt($('#update-train-economy-class').val()) &&
                    parseInt($('#update-train-confort-class').val()) &&
                    parseInt($('#update-train-average-speed').val()))
                {
                    var data = new Object();
                    data.id = train.id;
    ...
    $scope.addTrain = function () {
        ...
        $('#add-train-table').modal({
            relatedTarget: this,
            onConfirm: function (options) {
                if (parseInt($('#add-train-economy-class').val()) && parseInt($('#add-train-confort-class').val()) &&
                    parseInt($('#add-train-average-speed').val()))
                {
                    var data = new Object();
