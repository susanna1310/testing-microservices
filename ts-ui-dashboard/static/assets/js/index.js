var reserveApp = new Vue({
    ...
    methods: {
        ...
        preserverBooking(index, tripType, tripNum, from, to)
        {
            ...
            //                         location.href = "client_ticket_book.html?tripId=" + tripId + "&from=" + from +
            // "&to=" + to + "&seatType=" + that.selectedSeats[index] + "&seat_price=" + seatPrice + "&date=" +
            // that.selectedDate;  } else { alert(obj["message"]); } }, error: function (e) { alert("login error,
            // please login again!"); } }); }, onCancel: function (e) { // alert('cancel!'); } }); } else {
            // location.href = "client_ticket_book.html?tripId=" + tripId + "&from=" + from + "&to=" + to +
            // "&seatType=" + this.selectedSeats[index] + "&seat_price=" + seatPrice + "&date=" + this.selectedDate; }
