...
public class PriceServiceImplTest
{
    ...
    {
        Mockito.when(priceConfigRepository.findByRouteIdAndTrainType(Mockito.anyString(), Mockito.anyString()))
            .thenReturn(null);
    ...
    public void testDeletePriceConfig2()
    {
        ...
        Mockito.doNothing().doThrow(new RuntimeException()).when(priceConfigRepository)
