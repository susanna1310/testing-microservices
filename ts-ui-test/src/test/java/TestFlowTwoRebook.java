...
public class TestFlowTwoRebook
{
    ...
    public void testChangeOrder() throws Exception
    {
        ...
        for (i = 0; i < myOrdersList.size(); i++) {
            statusOrder =
                myOrdersList.get(i).findElement(By.xpath("div[2]//form[@role='form']/div[7]/div/label[2]")).getText();
        ...
        if (changeTicketsSearchList.size() > 0) {
            System.out.printf("Success to search tickets，the tickets list size is:%d%n",
