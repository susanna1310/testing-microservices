...
public class TestServiceInsidePay
{
    ...
    public void testInsidePayList() throws Exception
    {
        ...
        List<WebElement> insidePayList =
            driver.findElements(By.xpath("//table[@id='query_inside_payment_payment_list_table']/tbody/tr"));
    ...
    public void testUserBalance() throws Exception
    {
        ...
        List<WebElement> userBalanceList =
            driver.findElements(By.xpath("//table[@id='query_inside_payment_account_list_table']/tbody/tr"));
        if (userBalanceList.size() > 0) {
            System.out.printf("Success to Query UserBalanceList and UserBalanceList list size is %d.%n",
    ...
    public void testAddMoney() throws Exception
    {
        ...
        List<WebElement> addMoneyList =
            driver.findElements(By.xpath("//table[@id='query_inside_payment_add_money_list_table']/tbody/tr"));
        if (addMoneyList.size() > 0) {
            System.out.printf("Success to Query Add Money List and Add Money List list size is %d.%n",
                addMoneyList.size());
        } else {
