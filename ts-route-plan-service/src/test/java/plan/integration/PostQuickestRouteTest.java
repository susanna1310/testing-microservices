...
public class PostQuickestRouteTest extends  BaseIntegrationTest{

    private final String url = "/api/v1/routeplanservice/routePlan/quickestRoute";

    /*
     * The equivalence based test is designed to verify that the endpoint for retrieving the quickest trips on that route works correctly, with existing station names.
    ...
    /*
     * The equivalence based test is designed to verify that the endpoint for retrieving the quickest trips works correctly, when no trips are found with
