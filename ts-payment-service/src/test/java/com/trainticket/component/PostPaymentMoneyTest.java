...
/*
 * This POST endpoint expects a Payment object in the body and adds it to the addMoneyRepository. Therefore we have test
 * cases for the equivalence classes of the body object attributes as well as defects tests and tests for the REST
 * endpoint itself. It interacts only with the database, which is why we need to setup a MongoDBContainer for the repository.
 */
@SpringBootTest
@ExtendWith(SpringExtension.class)
@AutoConfigureMockMvc(addFilters = false)
@Testcontainers
public class PostPaymentMoneyTest {
	...
	*/
    ...
    void validTestCorrectObject() throws Exception {
        ...
        String result = mockMvc.perform(post("/api/v1/paymentservice/payment/money")
        ...
        assertEquals(new Response<>(1, "Add Money Success", JSONObject.parseObject(result, Response.class).getData()), JSONObject.parseObject(result, Response.class));
    ...
    void invalidTestMalformedObject() throws Exception {
        String requestJson = "{\"id\": wrong, \"orderId\": type, \"userId\": }";
    ...
    */
    ...
    /*
     * Here we assign a short valid String to the attributes, which means an empty String, and test the response of the endpoint
     */
    @Test
    ...
    */
    ...
    /*
     * This specific defect based test, tests the case when there is already the money object with the id in the
     * repository and checks the response for that case.
     */
    @Test
    void moneyAlreadyInRepository() throws Exception {
        String requestJson = "{\"id\":\"1234567890\", \"orderId\":\"1\", \"userId\":\"1\", \"price\":\"1\"}";
