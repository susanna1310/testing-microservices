 ...
 */
public class GetOrderServiceOrderTravelDateTrainNumberTest extends BaseComponentTest
{

	private final String url = "/api/v1/orderservice/order/{travelDate}/{trainNumber}";
	/*
	####################################
