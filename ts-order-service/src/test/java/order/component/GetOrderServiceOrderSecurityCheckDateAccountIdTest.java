 ...
 */
public class GetOrderServiceOrderSecurityCheckDateAccountIdTest extends BaseComponentTest
{

	private final String url = "/api/v1/orderservice/order/security/{checkDate}/{accountId}";
	/*
	####################################
	...
	*/
	...
	void invalidTestNonExistingId() {
		assertThrows(IllegalArgumentException.class, () -> {mockMvc.perform(get(url, new Date()));});
	}
