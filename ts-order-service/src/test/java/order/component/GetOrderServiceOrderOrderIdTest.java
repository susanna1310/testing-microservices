...
/*
 * This endpoint is designed to retrieve the order by the given order ID via GET request
 *
 * The tests are divided into two main categories:
 * - Method-specific test cases for the GET request.
 * - URL parameter-specific test cases.
 */
public class GetOrderServiceOrderOrderIdTest extends BaseComponentTest
{

	private final String url = "/api/v1/orderservice/order/{orderId}";
	/*
	####################################
	...
	*/
	...
	/*
	 * The test is designed to verify that the endpoint for retrieving the order by order ID works correctly, for a valid id with an order that exists in the database.
	...
	/*
	 * The test is designed to verify that the endpoint for retrieving the order security by order ID correctly handles the case
