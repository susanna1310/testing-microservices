 ...
 */
public class PutOrderServiceOrderAdminTest extends  BaseComponentTest
{

	private final String url = "/api/v1/orderservice/order/admin";
	/*
	####################################
	...
	*/
	...
	void invalidTestMissingObject() throws Exception {
		...
		TypeFactory typeFactory = objectMapper.getTypeFactory();
		Response<Order> response = objectMapper.readValue(result, typeFactory.constructParametricType(Response.class, Order.class));
		Assertions.assertEquals(new Response<>(0, "Order Not Found, Can't update", null), response);
	}
}