...
public class PostOrderServiceOrderRefreshTest {

    private final String url = "/api/v1/orderservice/order/refresh";
    ...
    void validTestNoOrdersFound() throws Exception {
        ...
        Assertions.assertEquals(new Response<>(1, "Query Orders For Refresh Success", new ArrayList()), JSONObject.parseObject(result,  new TypeReference<Response<ArrayList<Order>>>(){}));
    }
