...
@Testcontainers
public class PostTripsLeftTest {
    ...
    private final String url = "/api/v1/travelservice/trips/left";
    @Autowired
	...
	*/
    ...
    /*
     * This test is designed to verify that the endpoint correctly handles the case when the request is valid.
     */
    @Test
    void validTestObject() throws Exception {
    ...
    /*
     * The test is designed to verify that the endpoint correctly handles the case when the request is valid and checks the response for correct data.
     */
    @Test
    void validTestObjectCorrectly() throws Exception {
        ...
        info.setStartingPlace("Shang Hai");
        info.setEndPlace("Tai Yuan");
        info.setDepartureTime(new Date(1367643112000L));
        ...
        Trip trip = new Trip(
                ...
                "nanjing",
                "beijing",
                new Date(1367643112000L),
                new Date(1367664712000L)
        );
        ...
        tripResponse.setTrainTypeId("GaoTieOne");
    ...
    /*
     * The test is designed to verify that the endpoint correctly handles the case when the request is valid, but the tripId does not exist in the tripRepository.

     *
     * */
    @Test
    void invalidTestMissingTrip() throws Exception {
    ...
    /*
     * This test is designed to verify that the endpoint correctly handles the case when the request is valid, but the response is null.
     */
    @Test
    void invalidTestTripResponseNull() throws Exception {
        TripInfo info = new TripInfo();
        info.setStartingPlace("Shang Hai");
        info.setEndPlace("Bei Jing");
