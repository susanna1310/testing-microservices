...
public class FoodServiceImplTest
{
    ...
    {
        FoodOrder fo =
            new FoodOrder(UUID.randomUUID(), UUID.randomUUID(), 2, "station_name", "store_name", "food_name", 3.0);
    ...
    public void testDeleteFoodOrder2()
    {
        ...
        Mockito.doNothing().doThrow(new RuntimeException()).when(foodOrderRepository)
            .deleteFoodOrderByOrderId(Mockito.any(UUID.class));
        Response result = foodServiceImpl.deleteFoodOrder(orderId.toString(), headers);
    ...
    public void testUpdateFoodOrder2()
    {
        FoodOrder updateFoodOrder =
            new FoodOrder(UUID.randomUUID(), UUID.randomUUID(), 1, "station_name", "store_name", "food_name", 3.0);
