 ...
 */
public class GetOrderOtherServiceOrderOtherPriceOrderIdTest extends BaseComponentTest
{

	private final String url = "/api/v1/orderOtherService/orderOther/price/{orderId}";
	/*
	####################################
