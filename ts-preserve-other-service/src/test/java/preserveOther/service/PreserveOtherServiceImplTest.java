...
public class PreserveOtherServiceImplTest
{
    ...
    public void testPreserve()
    {
        ...
        travelResult.setPrices(new HashMap<String, String>()
        {{
        ...
        Mockito.when(restTemplate.exchange(
            ...
            .thenReturn(re2).thenReturn(re3).thenReturn(re4).thenReturn(re4).thenReturn(re5).thenReturn(re6)
            .thenReturn(re7).thenReturn(re8).thenReturn(re9);
    ...
    public void testDipatchSeat()
    {
        ...
        Ticket result =
            preserveOtherServiceImpl.dipatchSeat(new Date(mills), "G1234", "start_station", "dest_station", 2, headers);
