...
public class AssuranceServiceImpl implements AssuranceService
{
    ...
    public Response create(int typeIndex, String orderId, HttpHeaders headers)
    {
        ...
        if (a != null) {
            AssuranceServiceImpl.LOGGER.info(
                "[Assurance-Add&Delete-Service][AddAssurance] Fail.Assurance already exists");
            return new Response<>(0, "Fail.Assurance already exists", null);
        } else if (at == null) {
            AssuranceServiceImpl.LOGGER.info(
                "[Assurance-Add&Delete-Service][AddAssurance] Fail.Assurance type doesn't exist");
    ...
    public Response deleteById(UUID assuranceId, HttpHeaders headers)
    {
        ...
        if (a == null) {
            ...
            AssuranceServiceImpl.LOGGER.info(
                "[Assurance-Add&Delete-Service][DeleteAssurance] Fail.Assurance not clear.");
    ...
    public Response modify(String assuranceId, String orderId, int typeIndex, HttpHeaders headers)
    {
        ...
        if (oldAssurance == null) {
            ...
            if (at != null) {
                ...
                AssuranceServiceImpl.LOGGER.info(
                    "[Assurance-Modify-Service][ModifyAssurance] Fail.Assurance Type not exist.");
