...
/*
 * Integration test for the POST Travel Plan Transfer in the TravelPlanService.
 *
 ...
 *
 * Endpoint: POST /api/v1/travelplanservice/travelPlan/transferResult
 */
@SpringBootTest
...
public class PostTravelPlanTransferResultTest {
    ...
    private final String url = "/api/v1/travelplanservice/travelPlan/transferResult";
    @Autowired
	...
	*/
    ...
    void validTestCorrectObject() throws Exception {
        TransferTravelInfo transferTravelInfo = new TransferTravelInfo("Nan Jing", "Shang Hai", "Bei Jing", new Date("Mon May 04 09:00:00 GMT+0800 2025"), "gaoTieOne");

        String jsonRequest = objectMapper.writeValueAsString(transferTravelInfo);
     ...
     * There is no real handling, the service always returns Success.
     */
    @Test
    @Order(2)
    void validTestNoTrips() throws Exception {
        TransferTravelInfo transferTravelInfo = new TransferTravelInfo("Berlin", "Muenchen", "Berlin", new Date("Mon May 04 09:00:00 GMT+0800 2025"), "random");
