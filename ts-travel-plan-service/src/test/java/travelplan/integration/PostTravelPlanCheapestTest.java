...
/*
 * Integration test for the POST Travel Plan Cheapest in the TravelPlanService.
 *
 ...
 *
 * Endpoint: POST /api/v1/travelplanservice/travelPlan/cheapest
 */
@SpringBootTest
...
public class PostTravelPlanCheapestTest {
    ...
    private final String url = "/api/v1/travelplanservice/travelPlan/cheapest";
    @Autowired
