...
/*
 * Test class for POST /api/v1/travelplanservice/travelPlan/quickest endpoint
 * This endpoint wants to find the quickest travel routes between two stations on a specific date and return detailed information about these routes.
 *
 * Multiple requests are sent to different services:
 * A POST request is sent to ts-route-service to get the quickest routes based on the information in routePlanInfo and a list of RoutePlanResultUnit objects representing these routes is returned.
...
public class PostTravelPlanQuickestTest {
	...
	*/
    ...
    void validTestCorrectObject() throws Exception {
        ...
        routePlanResultUnit.setPriceForSecondClassSeat("100");
        ...
        mockServer.expect(requestTo("http://ts-route-plan-service:14578/api/v1/routeplanservice/routePlan/quickestRoute"))
        ...
        String response = mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/travelplanservice/travelPlan/quickest")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void invalidTestMultipleObjects() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/travelplanservice/travelPlan/quickest")
                        .contentType(MediaType.APPLICATION_JSON)
