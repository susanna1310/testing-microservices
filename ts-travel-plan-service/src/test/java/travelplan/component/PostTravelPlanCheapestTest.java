...
/*
 * Test class for POST /api/v1/travelplanservice/travelPlan/cheapest endpoint
 * This endpoint wants to find the cheapest travel routes between two stations on a specific date and return detailed information about these routes.
 *
 * Multiple requests are sent to different services:
 * A POST request is sent to ts-route-service to get the cheapest routes based on the information in routePlanInfo and a list of RoutePlanResultUnit objects representing these routes is returned.
...
@Testcontainers
public class PostTravelPlanCheapestTest {
    @Container
	...
	*/
    ...
    void validTestCorrectObject() throws Exception {
        ...
        mockServer.expect(requestTo("http://ts-route-plan-service:14578/api/v1/routeplanservice/routePlan/cheapestRoute"))
                .andExpect(method(HttpMethod.POST))
                .andRespond(withStatus(HttpStatus.OK)
                        .contentType(MediaType.APPLICATION_JSON)
                        .body(mapper.writeValueAsString(responseRoutePlanService)));

        ArrayList<String> stops = new ArrayList<>(Arrays.asList("StationA", "StationB"));
        Response<ArrayList<String>> responseStationService = new Response<>(1, "Success", stops);
        ...
        // Set Number of left Tickets to 50;
        int numOfLeftTicketFirst = 50;
        ...
        // Set Number of left Tickets to 100;
        int numOfLeftTicketSecond = 100;
        ...
        String response = mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/travelplanservice/travelPlan/cheapest")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void invalidTestMultipleObjects() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/travelplanservice/travelPlan/cheapest")
                        .contentType(MediaType.APPLICATION_JSON)
